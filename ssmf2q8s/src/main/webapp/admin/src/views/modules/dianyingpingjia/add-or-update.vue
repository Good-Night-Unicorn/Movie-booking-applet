  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="订单编号" prop="dingdanbianhao">
              <el-input v-model="ruleForm.dingdanbianhao" 
                placeholder="订单编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="电影名称" prop="dianyingmingcheng">
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.dianyingmingcheng" label="电影名称" prop="dianyingmingcheng">
          ...
          <el-form-item class="input" label="类型" prop="leixing">
              <el-input v-model="ruleForm.leixing" 
                placeholder="类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="电影评分" prop="dianyingpingfen">
          ...
          <el-form-item class="input" label="用户名" prop="yonghuming">
              <el-input v-model="ruleForm.yonghuming" 
                placeholder="用户名" readonly></el-input>
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="电影评价" prop="dianyingpingjia">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="电影评价"
                  v-model="ruleForm.dianyingpingjia" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dianyingpingjia" label="电影评价" prop="dianyingpingjia">
                    <span>{{ruleForm.dianyingpingjia}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    dianyingmingchengChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
                                                                                                      if(data.data.leixing){
                this.ruleForm.leixing = data.data.leixing
              }
                                                                                                                                                                                        } else {
          this.$message.error(data.msg);
        }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `dianyingpingjia/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.dianyingpingjiaCrossAddOrUpdateFlag = false;
                  this.parent.search();
